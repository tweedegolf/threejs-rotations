...
function create() {
  var size = arguments[0] === undefined ? 25 : arguments[0];
  ...
  var margin = 0.1 * textureSize;
  var stemWidth = 0.4 * textureSize;
  var stemHeight = 0.4 * textureSize;
  var arrowHeadHeight = 0.4 * textureSize;
...
var createArrow = _interopRequire(require("./create_arrow"));
...
function init() {
  ...
  // create floor
  var material = new THREE.MeshBasicMaterial({ wireframe: true, color: 0 });
...
},{"./create_arrow":1,"./create_controls":2,"./debug_axes_3d":3}],6:[function(require,module,exports){
(function (global){
"use strict";
